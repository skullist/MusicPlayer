package com.example.zhuyahui.musicplayer.playview;
...
/**
 * Created by Amin Ghabi on 12/07/15.
 */
public class MaterialMusicPlayerView extends View{
     ...
     * @param context
     */
    public MaterialMusicPlayerView(Context context) {
        super(context);
        init(context, null);
    }
     ...
     * @param attrs
     */
    public MaterialMusicPlayerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * @param defStyleAttr
     */
    public MaterialMusicPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setCoverDrawable(Drawable coverDrawable) {
        mBitmapCover = drawableToBitmap(coverDrawable);
        createShader();
        postInvalidate();
    }
